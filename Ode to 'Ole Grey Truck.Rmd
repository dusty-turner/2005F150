...
- There was a time when I was really racking up the miles.  Hawaii through Ohio was a prosperous time for the ol truck.  But if you notice, there's a clear inflection point in Ohio where things start dropping off.  This was when in December of 15 when we bought my wife's car.  In hindsight, it was the beginning of the end  :)
...
truck %>%
  ...
  geom_bar() +
  labs(x="Day of Week", y = "Number of Fillups", title = "What Day Did I Fill The Pick Up On The Most") +
  theme(legend.position = "none", axis.text.x = element_text(angle = 90, hjust = 1, vjust = .5))
```

The barchart indicates that I might fill up more on Friday than any other day.  I wonder if Location impacts the day I fill up? 
...
truck %>%
  ...
  geom_bar() +
  labs(x="Day of Week", y = "Number of Fillups", title = "What Day Did I Fill The Pick Up On The Most")  +
  facet_wrap(~forcats::fct_reorder(Location,FillUpDate)) + 
  theme(legend.position = "none", axis.text.x = element_text(angle = 90, hjust = 1))
```

It does appea Friday still leads, but evidence is less strong and I do not know exactly what to make of this.  Lets turn to a statistical test to help determine if what we are seeing could be explained by chance or if there really is something to this.
